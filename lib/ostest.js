...
(function() {
  var async, colors, fs, net, osTest, portProbe, ports, processHost, timeout;
  ...
  processHost = function(host) {
    return osTest(ports, host, timeout, function(error, port) {
      if (port === false) {
        return console.log(host.red);
      } else {
        switch (port) {
          case 22:
            return console.log(host.green);
          case 135:
            return console.log(host.blue);
          case 3389:
            return console.log(host.cyan);
          case 1022:
            return console.log(host.magenta);
          case 554:
            return console.log(host.yellow);
          default:
            return console.log(host.red);
        }
      }
